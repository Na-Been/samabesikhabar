                ...
                <div class="box">
                    <div class="grid grid-cols-12 mt-5 p-5">
                        <div
                            ...
                            {!! Form::text('title',old('title'),['class' => 'input w-full border flex-1','placeholder'=>'Enter Title', 'required']) !!}
                        ...
                        <div
                            ...
                            {!! Form::url('url',old('url'),['class'=>'input w-full border flex-1','placeholder' => 'URL....', 'required']) !!}
