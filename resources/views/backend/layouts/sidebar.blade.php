<nav class="side-nav">
    ...
    <ul id="mainsidebar">
        ...
        <li>
            <a href="javascript:;"
               class="side-menu {{request()->routeIs('news-category.index') || request()->routeIs('news.create') || request()->routeIs('news-sub-category.index') ||request()->routeIs('news.index')?'side-menu--active side-menu--open' : ''}} ">
                <div class="side-menu__icon"><i data-feather="package"></i></div>
                <div class="side-menu__title"> News List <i data-feather="chevron-down"
                                                            class="side-menu__sub-icon"></i></div>
            </a>
            <ul class="{{request()->routeIs('news-category.index') || request()->routeIs('news.create') || request()->routeIs('news-sub-category.create')|| request()->routeIs('news.index') ?'side-menu__sub-open' : ''}} ">
                <li>
        ...
        <li>
            <a href="{{route('add.live.link')}}" class="side-menu">
                <div class="side-menu__icon"><i data-feather="tv"></i></div>
                <div class="side-menu__title"> Live</div>
            </a>
        </li>
        <li>
