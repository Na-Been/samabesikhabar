                    ...
                    <div class="grid grid-cols-12 mt-5">
                        <div class="intro-y col-span-12 sm:col-span-9  p-2">
                            ...
                            <div
                                ...
                                {!! Form::select('display_name', [],null, ['id'=>'displayName','class' => 'input w-full border flex-1','placeholder'=>'Select One...','required']) !!}
                            ...
                            <div
                                ...
                                {!! Form::password('password',null,['class' => 'input w-full border flex-1','placeholder'=>'Enter Password','required']) !!}
                            ...
                            <div
                                ...
                                <div class="mb-2 font-medium">Confirm Password<span class="text-theme-6">*</span></div>
                                {!! Form::password('password_confirmation',null,['class' => 'input w-full border flex-1','placeholder'=>'Re-Enter Password','required']) !!}
                        ...
                        <div class="intro-y col-span-12 flex items-center  mt-5">
                            <button type="submit" class="button  justify-center block  text-white ml-2"
                                    style="background:#E3AF55">Add New User
                            </button>
                        </div>
                    </div>
                </div>
