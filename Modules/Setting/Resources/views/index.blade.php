                ...
                <div class="box">
                    <div class="grid grid-cols-12 mt-5">
                        <div
                            ...
                            {!! Form::text('site_title',getSetting('site_title'),['class' => 'input w-full border flex-1','placeholder'=>'Enter site Title']) !!}
                        ...
                        <div
                            class="intro-y col-span-12 sm:col-span-6  p-5 {{($errors->has('director')) ? 'has-error':''}} ">
                            <div class="mb-2 ">Director Name <span class="text-theme-6">*</span></div>
                            {!! Form::text('director',getSetting('director'),['class' => 'input w-full border flex-1','placeholder'=>'Enter director name']) !!}
                            {!! $errors->first('director', '<div class="pristine-error text-theme-6 mt-2">:message</div>') !!}
                        </div>
                        <div
                    ...
                    <div
                        class="intro-y col-span-12 sm:col-span-6  p-5">
                        <div class="mb-2 font-medium">Company Description<span class="text-theme-6">*</span></div>
                        {!! Form::textarea('company_details',getSetting('company_details'),['id'=>'ck-editor','placeholder' => 'Company Description']) !!}
                    </div>
