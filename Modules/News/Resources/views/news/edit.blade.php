                    ...
                    <div class="grid grid-cols-12 mt-5">
                        <div
                            ...
                            <div
                                ...
                                <div class="mb-2 font-medium">News Title <span class="text-theme-6">*</span></div>
                                   ...
                                   <span class="input-group-btn">
                                     <a id="lfm3" data-input="thumbnail2" data-preview="holder2" class="btn btn-primary"
                                      ...
                                      @if($news->author_image)
                                        ...
                                        <img src="{{$news->full_author_image}}" style="height: 5rem;">
                                        @else
                        ...
                        <div class="intro-y col-span-12 sm:col-span-3 p-2">
                            <div class="box">
                                ...
                                <div
                                    class="intro-y col-span-12 flex items-center justify-center sm:justify-end mb-23 p-5">
                                    <button type="submit"
                            ...
                            <div class="box mt-5">
                                <div
                                    ...
                                    <div class="mb-2 font-medium">Select Category & Sub Category <span
                                ...
                                <div
                                   ...
                                   <span class="input-group-btn">
                                     ...
                                     @if($news->feature_image)
                                            ...
                                            <img src="{{$news->full_feature_image}}" style="height: 5rem;">
                                            @else
